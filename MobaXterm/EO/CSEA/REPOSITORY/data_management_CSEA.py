...
csv_file_path_with_geometry = '/home/eodc/EO/CSEA/INPUT/Sentinel-2-collection-to-feature-CORTESSEA-5.csv'
...
gdf = gdf[~gdf['PRODUCT_ID'].str.startswith('S2A_OPER')]
...
output_file_path = os.path.join('/home/eodc/EO/CSEA/INPUT/', 'Sentinel-2-collection-to-feature-CORTESSEA-5.txt')
