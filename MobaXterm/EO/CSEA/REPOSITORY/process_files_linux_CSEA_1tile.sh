...
#chmod +x process_files_linux_CSEA_1tile.sh
#./process_files_linux_CSEA_1tile.sh
echo "Hello, World!"

# Set the input file containing file paths
inputFile="/home/eodc/EO/CSEA/INPUT/Sentinel-2-collection-to-feature-CORTESSEA-5.txt"

# Set the output directory where you want to unzip the files
outputDirectory="/eodc/private/deltares/EO/CSEA/INPUT/"
...
while IFS= read -r sourceFile; do
    ...
    cd "$acoliteDirectory"
    python launch_acolite.py --cli --settings=/home/eodc/EO/CSEA/INPUT/settings_CLI2_CSEA.txt --inputfile="$s2image"
