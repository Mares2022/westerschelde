...
for variable in variable_names:
  ...
  ds = xr.open_dataset(f'/home/eodc/EO/WS/RESULTS/window_extraction_output_{variable}.nc')
  ds
  ...
  df_window_all_vars.to_excel(f'/home/eodc/EO/WS/RESULTS/window_extraction_table_{variable}.xlsx', sheet_name='Sheet1', index=False)
