...
file_path_output_window_geojson = '/home/eodc/EO/WS_PRODUCTION/INPUT/window_extraction.geojson' 
...
for variable in variable_names:
  ...
  ds = xr.open_dataset(f'/eodc/private/deltares/NETCDFs/window_extraction_output_{variable}.nc')
  ds
  ...
  df_window_all_vars.to_excel(f'/home/eodc/EO/WS_PRODUCTION/RESULTS/window_extraction_table_{variable}.xlsx', sheet_name='Sheet1', index=False)
