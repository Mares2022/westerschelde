...
folder_path_l2w_data = r'D:\Projects\Westerschelde\OUTPUT\OUTPUT_10m'
...
file_path_output_window_geojson = r'D:\Projects\Westerschelde\OUTPUT\window_extraction.geojson' 
...
ds = xr.open_dataset(r'D:\Projects\Westerschelde\OUTPUT\window_extraction_output_new.nc')
ds
...
df_window_all_vars.to_csv(r'D:\Projects\Westerschelde\OUTPUT\window_extraction_table.csv')

# df_window_all_vars.to_excel(r'D:\Projects\Westerschelde\OUTPUT\window_extraction_table.xlsx', sheet_name='Sheet1', index=False)
