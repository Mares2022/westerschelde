...
inputFile="/home/eodc/INPUT/path_list_test_three_images.txt"

# Set the output directory where you want to unzip the files
outputDirectory="/home/eodc/INPUT/"
...
while IFS= read -r sourceFile; do
    ...
    cd "$acoliteDirectory"
    python launch_acolite.py --cli --settings=/home/eodc/INPUT/test_settings_CLI2.txt --inputfile="$s2image,$s2image_tile"
